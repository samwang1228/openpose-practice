...
class Pose:
    ...
    def draw(self, img,is_save=True,show_draw = True):
        ...
        if is_save:
            ...
            t = int(round(t * 1000))
            # delay2=1
            # cv2.imshow('Lightweight Human Pose Estimation Python Demo', I)
            # key = cv2.waitKey(delay2)
            cv2.imwrite(f'C:/Users/user/Desktop/test/img/{t}.jpg',I)
            # print(1)
        # **************************************
